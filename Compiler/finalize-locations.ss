#|
Program name    : finalize-locations.ss
Functions       : finalize-locations
...
;; Defines pass37 of the compiler
(define-who finalize-locations
  ...
  (define Triv
    (lambda (t)
      (if (uvar? t) (list-ref location-list (- (length uvars-list) (length (memv t uvars-list)))) t)))
  ;; It finalize locations of the Effect* part of grammer
  ;; It process mset!, set!, if, begin statements and replace the uvars with locations
